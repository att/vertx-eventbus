...
public class Server extends Verticle implements EventBusBridgeHook {

  public void start() {
    EventBus eb = vertx.eventBus();

    eb.registerHandler("my-address", new Handler<Message<JsonObject>>() {
      public void handle(Message<JsonObject> message) {
        ...
        eb.publish("my-handler", new JsonObject().putString("action", "message").putString("message", "This is a message"));
      }
    });
